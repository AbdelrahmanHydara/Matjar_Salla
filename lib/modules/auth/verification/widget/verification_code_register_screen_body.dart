...
class VerificationCodeRegisterScreenBody extends GetView<VerificationCodeRegisterController>
{
  const VerificationCodeRegisterScreenBody({super.key});

  @override
  Widget build(BuildContext context)
  {
    return GetBuilder<VerificationCodeRegisterController>(
        ...
        widget: Column(
          ...
          [
            ...
            OtpTextField(
              ...
              {
                controller.goToSuccessRegister(context,verificationCode);
              },
            ),
          ],
        ),
